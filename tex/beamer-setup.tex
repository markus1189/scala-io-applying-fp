...
\setbeamercolor{my header}{fg=DarkOrange,bg=Zeus}
\setbeamercolor{my footer}{fg=DarkOrange!90,bg=Zeus}
\setbeamercolor{my footer 2}{fg=DarkOrange!90,bg=Zeus!90}
\setbeamercolor{my page number}{fg=black,bg=DarkOrange!90}

\setbeamercolor{section in head/foot}{fg=white}
\setbeamercolor{mini frame}{fg=DarkOrange}
...
\setbeamercolor*{block title alerted}{use={normal text,alerted text},fg=black,bg=DarkOrange}
\setbeamercolor*{block body alerted}{bg=Zeus,fg=Zeus!20}

\setbeamercolor*{block title example}{fg=black,bg=DarkOrange!90}
